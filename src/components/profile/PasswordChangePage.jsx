    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (errorMessage.includes("different from the old password") || errorMessage.includes("same as the old password")) {
                errorMessage = t('errors.password_same_as_old');
            } else {
                errorMessage = error.message || t('password_page.errors.unknown');
            }
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                <Link to="/profile" className={styles.backButton}>
                    <FaArrowLeft /> <span>{t('actions.back_to_profile')}</span>
                </Link>
                    ...
                    <form onSubmit={handleSubmit} className={styles.form}>
                        ...
                        <div className={styles.buttonsContainer}>
                            ...
                            >
                                ...
                                {isSaving ? t('actions.saving') : t('actions.change_password')}
                            </button>
                        ...
                        <div className={styles.securityTipsDropdown}>
                            <button 
                                type="button"
                                className={`${styles.dropdownHeader} ${isTipsOpen ? styles.headerOpen : ''}`}
                            ...
                            <div className={`${styles.dropdownWrapper} ${isTipsOpen ? styles.open : ''}`}>
