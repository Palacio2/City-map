...
import type { StatRowProps, SectionProps } from '../types/geo';
...
export const StatRow = ({ label, value, highlight = false }: StatRowProps) => (
...
export const Section = ({ categoryConfig, data, formatValue }: SectionProps) => {
