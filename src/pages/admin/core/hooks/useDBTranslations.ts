...
export const useDBTranslations = () => {
    ...
    useEffect(() => {
        ...
        const bundles: Record<string, Record<string, string>> = { uk: {}, pl: {}, en: {} };

        translations.forEach(({ translation_key, uk, pl, en }: { translation_key: string, uk?: string, pl?: string, en?: string }) => {
