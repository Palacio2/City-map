...
export const getRegionsForCountry = (identifier?: string | null): string[] => {
...
export const generatePropertyLink = (countryName: string | null | undefined, city: string | null | undefined, district: string | null | undefined, region: string | null | undefined): string => {
