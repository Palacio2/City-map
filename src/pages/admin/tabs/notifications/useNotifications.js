...
export const useNotifications = () => {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            showAlert(t('common.success', {defaultValue: 'Успіх'}), t('notificationsTab.created', {defaultValue: 'Сповіщення створено'}), 'success');
        },
    ...
    const deleteNotification = (id) => {
        showConfirm(
            t('notificationsTab.deleteTitle'),
            t('notificationsTab.confirmDelete'),
